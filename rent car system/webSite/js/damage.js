...
function saveEmployee(){
 let vid=$('#exampleFormControlInput2').val();
 let des=$('#exampleFormControlInput3').val();
 let date=$('#exampleFormControlInput4').val();
 let image=$('#exampleFormControlInput3').val();
 let amount=$('#exampleFormControlInput4').val();
 let status=$('#exampleFormControlInput3').val();
